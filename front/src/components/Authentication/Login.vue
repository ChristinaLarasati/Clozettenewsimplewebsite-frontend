 ...
 <div class="wrapper fadeInDown">
  <div id="formContent">
    ...
    <div class="fadeIn first">
      <img src="http://danielzawadzki.com/codepen/01/icon.svg" id="icon" alt="Clozette User Login" />
    </div>

    <!-- Login Form -->
    <form>
      <input type="text" v-model="email" class="fadeIn second" name="login" placeholder="email">
      <input type="text" v-model="password" class="fadeIn third" name="login" placeholder="password">
...
export default {
    ...
    methods:{
      login(){
        var data= {
          client_id: 2,
          client_secret:'BQPaQR2eBKVpBjdHNFUfM0MPoux3LPyxMt2Ylhzm',
          grant_type: 'password',
          username: this.email,
          password: this.password
        }
        this.$http.post("http://localhost:8081/oauth/token", data)
          .then(Response=>{
            console.log(Response)
          })
        // .then(function(resoinse){
        //   console.log(Response)
        //})
      }
    }
